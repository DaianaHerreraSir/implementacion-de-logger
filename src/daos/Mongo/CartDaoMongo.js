...
async newCart() {
  ...
  async updateProductQuantity(cid, pid, quantity, res) {
    try {
      ...
      req.logger.error('Error en updateProductQuantity:', error);
      throw error;
    }
  }
